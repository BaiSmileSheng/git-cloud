...
@Slf4j
@Component
public class SettleRawScrapCompletedListener implements ExecutionListener {
    ...
    public void notify(DelegateExecution delegateExecution) {
        ...
        IActSmsRawScrapOrderService actSmsRawScrapOrderService = ApplicationContextUtil.getBean(IActSmsRawScrapOrderService.class);
//        RuntimeService runtimeService = delegateExecution.getEngineServices().getRuntimeService();
        ...
        R r = actSmsRawScrapOrderService.auditLogic(bizAudit, Long.valueOf(auditUserIdVal));
        if (r.isSuccess()) {
