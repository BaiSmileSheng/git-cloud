...
@Slf4j
@Component
public class SettleScrapNoPayProcListener implements ExecutionListener {
    ...
    public void notify(DelegateExecution delegateExecution) {
        ...
        IActSmsScrapOrderService actSmsScrapOrderService = ApplicationContextUtil.getBean(IActSmsScrapOrderService.class);
//        RuntimeService runtimeService = delegateExecution.getEngineServices().getRuntimeService();
        ...
        R r = actSmsScrapOrderService.auditNoPayLogic(bizAudit, Long.valueOf(auditUserIdVal));
        if (r.isSuccess()) {
