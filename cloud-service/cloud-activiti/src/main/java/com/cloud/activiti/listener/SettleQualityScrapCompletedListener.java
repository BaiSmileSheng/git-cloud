...
@Slf4j
@Component
public class SettleQualityScrapCompletedListener implements ExecutionListener {
    ...
    public void notify(DelegateExecution delegateExecution) {
        ...
        IActSmsQualityScrapOrderService actSmsQualityScrapOrderService = ApplicationContextUtil.getBean(IActSmsQualityScrapOrderService.class);
//        RuntimeService runtimeService = delegateExecution.getEngineServices().getRuntimeService();
        ...
        R r = actSmsQualityScrapOrderService.auditLogic(bizAudit, Long.valueOf(auditUserIdVal));
        if (r.isSuccess()) {
