...
import com.cloud.order.feign.factory.RemoteOmsRealOrderFallbackFactory;
 ...
 * @date 2020-06-18
 */
@FeignClient(name = ServiceNameConstants.ORDER_SERVICE, fallbackFactory = RemoteOmsRealOrderFallbackFactory.class)
