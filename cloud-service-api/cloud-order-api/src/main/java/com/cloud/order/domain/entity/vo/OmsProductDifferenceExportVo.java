...
import com.cloud.order.converter.ProductTypeOrderConverter;
...
@NoArgsConstructor
@Builder
public class OmsProductDifferenceExportVo extends BaseEntity{
     ...
     */
    @ExcelProperty(value = "产品类别",index = 1,converter = ProductTypeOrderConverter.class)
