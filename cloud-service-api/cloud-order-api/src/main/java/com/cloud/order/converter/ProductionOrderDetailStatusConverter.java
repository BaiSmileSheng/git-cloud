...
import com.cloud.order.enums.ProductionOrderDetailStatusEnum;

/**
 * 委外方式转化器
 * @author cs
 */
public class ProductionOrderDetailStatusConverter implements Converter<String> {
    ...
    public String convertToJavaData(CellData cellData, ExcelContentProperty excelContentProperty, GlobalConfiguration globalConfiguration)  {
        ...
        return ProductionOrderDetailStatusEnum.getCodeByMsg(stringValue);
    }
    ...
    public CellData convertToExcelData(String string, ExcelContentProperty excelContentProperty, GlobalConfiguration globalConfiguration) {
        return new CellData(ProductionOrderDetailStatusEnum.getMsgByCode(string));
    }
}
