...
@Slf4j
@Component
public class RemoteActSmsQualityScrapOrderFallbackFactory implements FallbackFactory<RemoteActSmsQualityScrapOrderService> {

    @Override
    public RemoteActSmsQualityScrapOrderService create(Throwable throwable) {
        return new RemoteActSmsQualityScrapOrderService() {
            /**
