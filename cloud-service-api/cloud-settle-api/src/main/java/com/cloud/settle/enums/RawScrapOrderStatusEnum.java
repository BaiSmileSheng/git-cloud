...
public enum RawScrapOrderStatusEnum {
    ...
    YCLBF_ORDER_STATUS_JITBH("1", "JIT驳回"),
    YCLBF_ORDER_STATUS_DDJLSH("2", "待订单经理审核"),
    YCLBF_ORDER_STATUS_DDJLBH("2", "订单经理驳回"),
    YCLBF_ORDER_STATUS_TRCCSH("3", "待投入产出审核"),
    YCLBF_ORDER_STATUS_TRCCBH("3", "投入产出驳回"),
