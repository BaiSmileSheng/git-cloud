...
@Builder
@ApiModel(value = "其他索赔")
public class SmsClaimOtherExportVo{
     ...
     * 索赔单号
     */
    @ExcelProperty(value = "索赔单号",index = 4)
     ...
     * 索赔原因
     */
    @ExcelProperty(value = "索赔原因",index = 5)
     ...
     */
    @ExcelProperty(value = "索赔状态",index = 6,converter = ClaimOtherStatusConverter.class)
     ...
     * 创建者
     */
    @ExcelProperty(value = "提报人",index = 9)
    private String createBy;

    /**
     * 提交时间
     */
    @ExcelProperty(value = "提报时间",index = 10)
