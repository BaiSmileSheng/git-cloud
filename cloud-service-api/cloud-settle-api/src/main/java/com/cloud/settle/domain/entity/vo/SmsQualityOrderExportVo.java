...
@Builder
@ApiModel(value = "质量索赔 ")
public class SmsQualityOrderExportVo {
     ...
     */
    @ExcelProperty(value = "质量索赔状态 ",index = 12,converter = QualityStatusConverter.class)
    ...
    @ExcelProperty(value = "问题分类",index = 10)
     ...
     * 索赔理由
     */
    @ExcelProperty(value = "索赔理由",index = 11)
    ...
    @ExcelProperty(value = "索赔金额(元)",index = 8)
     ...
     * 创建者
     */
    @ExcelProperty(value = "提报人",index = 13)
    ...
    @ExcelProperty(value = "提报时间",index = 14)
     ...
     * 申诉描述
     */
    @ExcelProperty(value = "申诉描述",index = 16)
     ...
     * 申诉时间
     */
    @ExcelProperty(value = "申诉时间",index = 17)
     ...
     * 供应商确认时间
     */
    @ExcelProperty(value = "供应商确认时间",index = 15)
     ...
     * 结算金额
     */
    @ExcelProperty(value = "实际结算金额(元)",index = 9)
