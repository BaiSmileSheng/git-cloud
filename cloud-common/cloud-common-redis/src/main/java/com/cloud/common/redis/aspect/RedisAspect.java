package com.cloud.common.redis.aspect;
...
public class RedisAspect {
     ...
     */
    @Pointcut("@annotation(com.cloud.common.redis.annotation.RedisCache)")
    public void redisCachePoint() {
    }

    @Pointcut("@annotation(com.cloud.common.redis.annotation.RedisEvict)")
